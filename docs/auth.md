...
import { pathToJS } from 'redux-devshare'
@connect(
  // Map state to props
  ({ firebase }) => ({
...
#### NOTE
All examples below assume you have wrapped your component using `devshareConnect`. This will make `this.props.firebase` available within your component:
...
export default devshareConnect()(SomeComponent)
```
